/**
 * MiniChartWidget Component
 * 
 * This component renders a TradingView widget displaying a "Mini Chart" for a given stock symbol.
 * It dynamically loads the TradingView script and configures the widget based on the provided symbol.
 * 
 * @module MiniChartWidget
 */

import React, { useEffect, useRef, memo } from 'react';

/**
 * Props for the MiniChartWidget component
...
/**
 * MiniChartWidget functional component
 * 
 * @param {MiniChartWidgetProps} props - The props for the component
 * @returns {React.ReactElement} The rendered MiniChartWidget
 */
function MiniChartWidget({ symbol }: MiniChartWidgetProps): React.ReactElement {
  ...
  useEffect(() => {
    ...
    const config = {
      symbol: `${symbol}`,                    // Set the symbol for short volume data
